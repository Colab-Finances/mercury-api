...
class TestFindMovementQueryHandler:
    ...
    async def test_should_return_an_expense(self) -> None:
        ...
        self._repository.search.assert_called_once_with(self.expense.id)
    ...
    async def test_should_return_an_income(self) -> None:
        ...
        self._repository.search.assert_called_once_with(self.income.id)
    ...
    async def test_should_return_a_transfer(self) -> None:
        ...
        self._repository.search.assert_called_once_with(self.transfer.id)
